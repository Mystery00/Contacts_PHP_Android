...
CREATE TABLE `table_email` (
  ...
  CONSTRAINT `contacts_email` FOREIGN KEY (`contact_id`) REFERENCES `table_contacts` (`contact_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
...
CREATE TABLE `table_phone` (
  ...
  KEY `contacts_idx` (`contact_id`),
  CONSTRAINT `contacts_phone` FOREIGN KEY (`contact_id`) REFERENCES `table_contacts` (`contact_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = InnoDB
